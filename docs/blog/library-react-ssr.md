...
最近在学习 React 的服务端渲染，于是使用 Express+React 写了一个 Demo，用于对比和客户端渲染的差异。[github 地址](https://github.com/mengsixing/react-ssr-demo)
...
如果觉得有用得话给个 ⭐ 吧。[react-ssr-demo](https://github.com/mengsixing/react-ssr-demo)
